...
int main(int argc, char *argv[]) {
    ...
    std::string nnet_dir = "exp/online";
    std::string graph_dir = nnet_dir + "/graph";
...
//    fprintf(stderr ,"denis pal output %s %d %d\n",
//        feature_info.feature_type.c_str(),
//        feature_info.use_ivectors,
//        feature_info.ivector_extractor_info.ExpectedFeatureDim()
//    );
    ...
    nnet_simple_looped_opts.frames_per_chunk = 20;
    nnet_simple_looped_opts.extra_left_context_initial= 0;
